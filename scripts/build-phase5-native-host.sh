...
grep -q '^native_preferences_store=PASS
...
grep -q '^electron_migration_runtime=PASS
grep -q '^native_framebuffer_variation=PASS$' "$EVIDENCE_DIR/prepackage-self-test.txt"
test -s "$framebuffer"
test -s "$render_trace"
framebuffer_bytes="$(stat -c%s "$framebuffer")"
...

{
 ...
 "$EVIDENCE_DIR/prepackage-self-test.txt"
grep -q '^native_pointer_menu=PASS
grep -q '^native_framebuffer_variation=PASS$' "$EVIDENCE_DIR/prepackage-self-test.txt"
test -s "$framebuffer"
test -s "$render_trace"
framebuffer_bytes="$(stat -c%s "$framebuffer")"
...

{
 ...
 "$EVIDENCE_DIR/prepackage-self-test.txt"
grep -q '^native_locale_menu=PASS
grep -q '^native_framebuffer_variation=PASS$' "$EVIDENCE_DIR/prepackage-self-test.txt"
test -s "$framebuffer"
test -s "$render_trace"
framebuffer_bytes="$(stat -c%s "$framebuffer")"
...

{
 ...
 "$EVIDENCE_DIR/prepackage-self-test.txt"
grep -q '^native_external_url_allowlist=PASS
grep -q '^native_framebuffer_variation=PASS$' "$EVIDENCE_DIR/prepackage-self-test.txt"
test -s "$framebuffer"
test -s "$render_trace"
framebuffer_bytes="$(stat -c%s "$framebuffer")"
